...
import { log_tick_pos, filter_count, sample_count, checkSolution } from "./partial/shared/utilsGeneral";
...
function EQGraphic({ getInitFilters, getNewSol, InputSection, Player }) {
    ...
    const [userFilters, setUserFilters] = useState(getInitFilters());
    ...
    const [solFilters, setSolFilters] = useState(getNewSol());
    ...
    const initSetup = () => {
        ...
        setSolFilters(getInitFilters());
        setUserFilters(getInitFilters());
